...
from sklearn.model_selection import train_test_split # Mengimpor fungsi train_test_split dari scikit-learnuntuk membagi data menjadi data pelatihan dan pengujian.
...
# Load data # Memuat dataset diabetes dari file CSV yang berisi informasi pasien dan hasilpemeriksaan diabetes.
...
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.2) # Menggunakan fungsitrain_test_split dari scikit-learn untuk membagi data.
...
# Save test data # Menyimpan data hasil pengujian (X_test dan y_test) untuk referensi atau analisislebih lanjut.
